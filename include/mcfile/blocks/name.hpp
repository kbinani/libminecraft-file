...
static inline std::optional<Characteristics> BlockCharacteristic(BlockId id) {
    static std::map<BlockId, Characteristics> const mapping = {
        ...
        {minecraft::blast_furnace, { .name = "minecraft:blast_furnace", .opaque = true}},
        ...
        {minecraft::furnace, { .name = "minecraft:furnace", .opaque = true}},
        ...
        {minecraft::granite, { .name = "minecraft:granite", .opaque = false}},
